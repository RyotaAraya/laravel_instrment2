    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <a class="" href="https://instrment-aws-infra.s3-ap-northeast-1.amazonaws.com/tasks_image/{{ $task->picture1 }}" data-lightbox="group">
              <img class="img" src="https://instrment-aws-infra.s3-ap-northeast-1.amazonaws.com/tasks_image/{{ $task->picture1 }}" style="max-width: 100%; height:auto;" />
            </a></p>
          </div>
        </div>
        <!-- 画像2 -->
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <a class="" href="https://instrment-aws-infra.s3-ap-northeast-1.amazonaws.com/tasks_image/{{ $task->picture2 }}" data-lightbox="group">
              <img class="img" src="https://instrment-aws-infra.s3-ap-northeast-1.amazonaws.com/tasks_image/{{ $task->picture2 }}" style="max-width: 100%; height:auto;" />
            </a></p>
          </div>
        </div>
        <div class="form-group row">
