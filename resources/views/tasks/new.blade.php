        ...
        <div class="card-body">
          <form method="POST" action="{{ route('tasks.create') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="trouble_content" type="text" class="form-control @error('trouble_content') is-invalid @enderror" name="trouble_content" value="{{ old('trouble_content') }}" autocomplete="trouble_content" autofocus>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="details_repair" type="text" class="form-control @error('details_repair') is-invalid @enderror" name="details_repair" value="{{ old('details_repair') }}" autocomplete="details_repair" autofocus>
