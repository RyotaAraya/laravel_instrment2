      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <div for="plant_name" class="col-md-2 text-md-right">{{ __('plant_name') }}</div>
            <div class="col-md-4">{{ $task->plant_name }}</div>
          </div>

          <!-- タグナンバー -->
          <div class="form-group row">
            <div for="plant_name" class="col-md-2 text-md-right">{{ __('tag_no') }}</div>
            <div class="col-md-4">{{ $task->tag_no }}</div>
          </div>
